  ...
  return (
    <div className="fixed bottom-4 right-4 max-w-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-4 z-50">
      <div className="flex justify-between items-start mb-2">
        <h3 className={`text-sm font-semibold text-burgundy-800 dark:text-burgundy-300 ${robotoMono.className}`}>Privacy Notice</h3>
        <button 
      ...
      <div className="flex gap-2 justify-end">
        <button
          ...
          className={`px-3 py-1 text-xs border border-burgundy-700 dark:border-burgundy-500 text-burgundy-700 dark:text-burgundy-300 rounded hover:bg-burgundy-50 dark:hover:bg-burgundy-900/20 ${robotoMono.className}`}
        >
          Settings
        </button>
        <button
          onClick={acceptCookies}
          className={`px-3 py-1 text-xs bg-burgundy-700 dark:bg-burgundy-800 text-black dark:text-white rounded hover:bg-burgundy-800 dark:hover:bg-burgundy-700 ${robotoMono.className}`}
        >
          Accept All
        </button>
      </div>
